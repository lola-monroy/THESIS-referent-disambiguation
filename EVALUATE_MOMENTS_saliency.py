#!/usr/bin/env python3
# ====== CONFIG / PATHS ======
DEFAULT_VIDEO_DIR = "/scratch/monroy/Playground/datasets/SALIENCY_MAP_WITH_AUDIO"
DEFAULT_OUT_DIR   = "/scratch/monroy/Playground/YOLO_Experiments/it5_saliency_map"
