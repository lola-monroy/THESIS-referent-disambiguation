#!/usr/bin/env python3
"""
EVALUATE_MOMENTS1_dis.py
To evaluate on diambiguated videos 
-----------------------------------
...
# ====== CONFIG / PATHS ========================================================
# ==============================================================================
DEFAULT_VIDEO_DIR = "/scratch/monroy/Playground/datasets/MoMentS_val_videos_emo_PATCHED_REFDIS_AUDIO"
...
DEFAULT_OUT_DIR   = "/scratch/monroy/Playground/REFDIS_960_patched"
